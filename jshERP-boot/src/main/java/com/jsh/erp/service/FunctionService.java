...
public class FunctionService {
        ...
        try {
            if (BusinessConstants.DEFAULT_MANAGER.equals(userService.getCurrentUser().getLoginName())) {
                ...
                logService.insertLog("功能",
                        new StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_ADD).append(functions.getName())
                                .toString(),
                        request);
            }
        } catch (Exception e) {
    ...
    public int updateFunction(JSONObject obj, HttpServletRequest request) throws Exception {
        ...
        try {
            if (BusinessConstants.DEFAULT_MANAGER.equals(userService.getCurrentUser().getLoginName())) {
                ...
                logService.insertLog("功能",
                        new StringBuffer(BusinessConstants.LOG_OPERATION_TYPE_EDIT).append(functions.getName())
                                .toString(),
                        request);
            }
        } catch (Exception e) {
    ...
    public int batchDeleteFunctionByIds(String ids) throws Exception {
        ...
        try {
            if (BusinessConstants.DEFAULT_MANAGER.equals(userService.getCurrentUser().getLoginName())) {
                result = functionMapperEx.batchDeleteFunctionByIds(new Date(),

...
// -------------------------------------------------
    ...
    public void setRemarks(String remarks) { this.remarks = remarks == null ? null : remarks.trim(); }
    ...
    public void setBillAddress(String billAddress) { this.billAddress = billAddress == null ? null : billAddress.trim(); }
    ...
    public void setPostal(String postal) { this.postal = postal == null ? null : postal.trim(); }

    public String getEnrollment() { return enrollment; }

    public void setEnrollment(String enrollment) { this.enrollment = enrollment == null ? null : enrollment.trim(); }

    public String getWebsite() { return website; }

    public void setWebsite(String website) { this.website = website == null ? null : website.trim(); }
    ...
    public String getShippingAcc() { return shippingAcc; }

    public void setShippingAcc(String shippingAcc) { this.shippingAcc = shippingAcc == null ? null : shippingAcc.trim(); }

    public String getEIN() { return EIN; }

    public void setEIN(String EIN) { this.EIN = EIN == null ? null : EIN.trim(); }

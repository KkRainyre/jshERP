...
public class Lcagent {
    ...
    public void setEmployId(String employId) { this.employId = employId; }
    ...
    public void setExt4(String ext4) { this.ext4 = ext4; }

    public String getExt5() { return ext5; }
    public void setExt5(String ext5) { this.ext5 = ext5; }
